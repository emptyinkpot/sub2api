...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/proxy-assignment/preview", h.Admin.Account.PreviewProxyAssignment)
		accounts.POST("/proxy-assignment/apply", h.Admin.Account.ApplyProxyAssignment)
...
func registerProxyRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	proxies := admin.Group("/proxies")
	{
		...
		proxies.GET("/risk-summary", h.Admin.Proxy.GetRiskSummary)
