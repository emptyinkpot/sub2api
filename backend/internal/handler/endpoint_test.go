...
func TestDeriveUpstreamEndpoint(t *testing.T) {
	tests := []struct {
		...
		{"glm embeddings", EndpointEmbeddings, "/v1/embeddings", service.PlatformGLM, EndpointEmbeddings},
		...
		{"unknown platform", EndpointEmbeddings, "/v1/embeddings", "unknown", EndpointEmbeddings},
	}
	for _, tt := range tests {
