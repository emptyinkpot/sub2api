<template>
  <div class="flex flex-wrap items-center gap-2">
    ...
    <Select :model-value="filters.group" class="w-36" :options="gOpts" @update:model-value="updateGroup" @change="$emit('change')" />
  </div>
</template>
...
const pOpts = computed(() => [{ value: '', label: t('admin.accounts.allPlatforms') }, { value: 'anthropic', label: 'Anthropic' }, { value: 'openai', label: 'OpenAI' }, { value: 'glm', label: 'GLM' }, { value: 'gemini', label: 'Gemini' }, { value: 'antigravity', label: 'Antigravity' }])
