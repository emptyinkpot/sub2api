<template>
  ...
  <!-- Coze logo proxy mark -->
  <svg v-else-if="platform === 'coze'" :class="sizeClass" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    <path stroke-linecap="round" stroke-linejoin="round" d="M7 8h10M7 12h6m-1 8 4-4h1a4 4 0 0 0 4-4V8a4 4 0 0 0-4-4H7a4 4 0 0 0-4 4v4a4 4 0 0 0 4 4h1l4 4z" />
  </svg>
