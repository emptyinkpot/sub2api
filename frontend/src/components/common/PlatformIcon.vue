<template>
  ...
  <svg v-else-if="platform === 'glm'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 2.5 20.2 7v10L12 21.5 3.8 17V7L12 2.5Zm0 2.3L5.8 8.2v7.6l6.2 3.4 6.2-3.4V8.2L12 4.8Zm0 3.2a4 4 0 0 1 3.72 2.53h-2.1A2.2 2.2 0 1 0 12 14.5h1.7v-1.3h-2.2v-1.7h4.1v4.7H14l-.18-.72A4 4 0 1 1 12 8Z" />
  </svg>
