export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      providerPreset: 'Upstream vendor preset',
      providerPresetHint: 'Auto-fills platform, base URL, and model mapping for API key accounts',
      providerPresetManual: 'No preset — choose platform manually',
      allPlatforms: 'All Platforms',
      allTypes: 'All Types',
      allStatus: 'All Status',
      allGroups: 'All Groups',
      ...
      clone: 'Clone Account',
      cloneSuccess: 'Account {name} cloned',
