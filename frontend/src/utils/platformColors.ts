...
export type Platform = 'anthropic' | 'openai' | 'glm' | 'antigravity' | 'gemini'
...
const BADGE: Record<Platform, string> = {
  ...
  glm: 'bg-cyan-500/10 text-cyan-600 border-cyan-500/30 dark:text-cyan-400',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  glm: 'bg-cyan-500/10 text-cyan-600 dark:bg-cyan-500/10 dark:text-cyan-300',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  glm: 'bg-gradient-to-r from-cyan-400 to-cyan-500',
...
const TEXT: Record<Platform, string> = {
  ...
  glm: 'text-cyan-600 dark:text-cyan-400',
...
const ICON: Record<Platform, string> = {
  ...
  glm: 'text-cyan-500 dark:text-cyan-400',
...
const BUTTON: Record<Platform, string> = {
  ...
  glm: 'bg-cyan-600 text-white hover:bg-cyan-700 active:bg-cyan-800 dark:bg-cyan-600/80 dark:hover:bg-cyan-600',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  glm: 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/40 dark:text-cyan-300',
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'glm' || p === 'antigravity' || p === 'gemini'
}
